...
- 📄 ZenDivider was originally a single-page application: a single HTML file that you can open in a browser. You can use it without getting this extension. ~~Learn more [here](https://github.com/BarnMTB/ZenDivider).~~ More information soon!
